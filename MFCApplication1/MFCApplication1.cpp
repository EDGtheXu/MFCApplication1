...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_COMMAND(ID_SOLID, &CAboutDlg::OnSolid)
	ON_COMMAND(ID_SHADOW, &CAboutDlg::OnShadow)
	ON_COMMAND(ID_BITMAP, &CAboutDlg::OnBitmap)
END_MESSAGE_MAP()
...
void CAboutDlg::OnShadow()
{
	// TODO: 在此添加命令处理程序代码
}


void CAboutDlg::OnBitmap()
{
	// TODO: 在此添加命令处理程序代码
}
